...
namespace cloud.charging.open.EMSP
{
    ...
    /// <summary>
    /// One assembly this EMSP is running, and the commit it was built from
    ...
    /// <summary>
    /// What this EMSP was built from, read from the assemblies themselves.
    /// </summary>
    /// <remarks>
    ...
    public static class BuiltFrom
    {
        ...
        private static IReadOnlyList<LoadedAssembly> Collect()
        {
            ...
            // EMSP does not reference and would otherwise be missing from
            ...
            while (queue.Count > 0)
            {
                ...
                foreach (var reference in assembly.GetReferencedAssemblies())
                {
                    ...
                    // depending on how the EMSP was started.
                    try
                    {
