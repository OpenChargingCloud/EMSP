...
namespace cloud.charging.open.EMSP.Configuration
{
    ...
    /// <summary>
    /// The "dns" section of the configuration file: how this EMSP
    /// resolves names.
    /// </summary>
    /// <remarks>
    /// Every field is optional, and null means "the file does not say" rather
    /// than "the file says nothing": what is missing keeps whatever the EMSP
    /// was given at construction, and an EMSP given nothing keeps the system
    ...
    /// </remarks>
    /// <param name="Enabled">Whether this EMSP resolves names at all.</param>
                                          ...
                                          Byte?                           MaxRetries            = null)
    {
        ...
        /// <summary>
        /// The most name servers one EMSP may be given. Not a rule of DNS -
        /// a query goes to all of them at once, and a hundred of them would be
        /// a hundred packets for every name this EMSP ever looks up.
        /// </summary>
