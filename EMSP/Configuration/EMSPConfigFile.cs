...
namespace cloud.charging.open.EMSP.Configuration
{
    ...
    /// <summary>
    /// The configuration of this EMSP, in a file beside it.
    /// </summary>
    /// <remarks>
    /// What an EMSP is - what it is called in OCPI, where it
    ...
    /// </remarks>
    public sealed class EMSPConfigFile
    {
        ...
        /// </summary>
        public EMSPConfigFile(String Path)
        {
        ...
        /// </summary>
        public Boolean TryLoad([NotNullWhen(true)] out EMSPConfiguration?  Configuration,
                                                   out String?                Error)
        {
            ...
            if (!EMSPConfiguration.TryParse(document, out Configuration, out var problem))
            {
                Error = $"'{Path}': {problem}";
                return false;
            }
        ...
        /// </summary>
        /// <remarks>
        /// This is what makes a partial save safe: an EMSP that only
                                       ...
                                       [NotNullWhen(false)] out String?   Error)
        {
            ...
            if (!File.Exists(Path))
            {
                // No file is not a failure, it is an EMSP nobody has
        ...
        /// rather than half of the new one. An EMSP that cannot read
        ...
        /// now - and a file that stops the EMSP is worse than a save that
        /// is refused.
        /// </remarks>
                                ...
                                [NotNullWhen(false)] out String?  Error)
        {
            ...
            try
            {
                ...
                // Move, not copy: on every file system this EMSP runs on
