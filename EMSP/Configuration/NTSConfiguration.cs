...
namespace cloud.charging.open.EMSP.Configuration
{
    ...
    /// <summary>
    /// The "nts" section of the configuration file: where this EMSP
    ...
    /// missing keeps whatever the EMSP was given at construction.
    /// </remarks>
    /// <param name="Enabled">Whether this EMSP asks a time server at all.</param>
    ...
    /// <param name="CheckEvery">How often this EMSP checks its clock against that server.</param>
    /// <param name="LegalTimeAuthority">Who stands behind that server's time, e.g. "PTB" - the operator saying so, because this EMSP cannot find out by itself.</param>
    /// <param name="LegalTimeTolerance">How far this EMSP's own clock may be from it and still count.</param>
    /// <param name="LegalTimeMaxAge">How old the last check may be and still count.</param>
    /// <param name="Servers">Every time server of this EMSP, or none to ask only the one named by Hostname.</param>
                                          ...
                                          TimeSpan?                             MaxDeviation          = null)
    {
        ...
        /// <summary>
        /// How often this EMSP checks its clock against its time server,
        ...
        /// public time server does not notice this EMSP at all.
        /// </remarks>
        public static readonly TimeSpan  DefaultCheckEvery        = TimeSpan.FromMinutes(15);

        /// <summary>
        /// How far this EMSP's clock may be from the time it was checked
        ...
        /// <summary>
        /// The time server this EMSP asks when nothing says otherwise.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The time servers this EMSP asks when its configuration names none.
        /// </summary>
        /// <remarks>
        ...
        /// leave this EMSP without a clock, and because two servers that agree
        ...
        /// <summary>
        /// The group an EMSP asks when nothing has said otherwise.
        /// </summary>
        ...
        /// <summary>
        /// The time servers of this EMSP as a group that can be asked.
        /// </summary>
        /// <remarks>
        /// Called "legal" after the white paper's well-known group, because
        /// this is the clock a charge is billed by. An EMSP asking a second
