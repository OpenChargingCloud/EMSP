...
namespace cloud.charging.open.EMSP
{
    ...
    /// <summary>
    /// What time this EMSP thinks it is, and what that is worth.
    /// </summary>
    /// <remarks>
    /// Two different questions, and an EMSP has to keep them apart.
    ...
    /// **this EMSP does not set its clock from the answer**. It measures the
    /// difference and reports it.
    ///
    /// That is deliberate. An EMSP stamps everything its roaming partners send
    ...
    /// <c>nts.legalTimeAuthority</c>, and this EMSP then only repeats that
    ...
    /// EMSP that has not checked, and the whole point of not
    ...
    public partial class EMSP
    {
        ...
        /// <summary>
        /// How often this EMSP checks its clock.
        /// </summary>
        ...
        /// <summary>
        /// How far this EMSP's clock may be off and still count.
        /// </summary>
        ...
        /// <summary>
        /// Begin checking this EMSP's clock against its time server.
        /// </summary>
        /// <remarks>
        /// Through the EMSP's own <see cref="TimeProvider"/> rather than a
        ...
        private void StartCheckingTheClock()
        {
            ...
            if (!NTSEnabled)
            {
                Log.Info("The clock of this EMSP is not being checked: NTS is switched off.", "nts", "clock");
                return;
            }
            ...
            Log.Info(
                $"The clock of this EMSP will be checked against {ntsClient.Hostname} every {TimeCheckEvery.TotalMinutes:F0} minute(s)" +
        ...
        private async Task CheckTheClockAsync()
        {
            ...
            try
            {
                ...
                if (result.Value<Boolean>("ok") != true)
                    Log.Warning(
                        $"The clock of this EMSP could not be checked: {result.Value<String>("error") ?? "no answer"}.",
                        "nts", "clock"
                    );
            ...
            {
                Log.Warning($"The clock of this EMSP could not be checked: {e.Message}", "nts", "clock");
            }
        ...
        public JObject ClockJSON()
        {
            ...
            return new JObject(
                       ...
                       // Said out loud: the number above is this EMSP's own
