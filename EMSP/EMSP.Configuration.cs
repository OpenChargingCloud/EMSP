    ...
    public partial class EMSP
    {
        ...
        public JObject DNSConfigurationJSON()
            ...
            => new (
                   ...
                   // The servers this EMSP would ask, which is not the same
        ...
        /// <summary>
        /// Change how this EMSP resolves names, at once and for everything
                                                 ...
                                                 [NotNullWhen(false)] out String?  Error)
        {
            ...
            {
                Error = "An EMSP that resolves no names cannot reach its time server, nor anything else it is pointed at by name. Switch name resolution off instead of emptying the list.";
                return false;
            }

            // Under the same lock as every other change to this EMSP:
        ...
        private void ApplyDNSConfiguration(DNSConfiguration Configuration)
        {
            ...
            // must end up holding exactly the servers this EMSP means it to
        ...
        /// <summary>
        /// Where this EMSP gets the time from, and how the key exchange
        /// behind it is doing.
        /// </summary>
        /// <remarks>
        ...
        /// "keyExchange" - which read as the EMSP's time server and the
        ...
        public JObject NTSConfigurationJSON()
        {
            ...
            return new JObject(
                       ...
                       // it is in effect. The quorum is the one this EMSP
                       ...
                       // checks this EMSP's clock: each server's key
        ...
        /// <summary>
        /// Change where this EMSP reads the time.
        /// </summary>
        /// <remarks>
        /// Pointing the EMSP at another server replaces the client rather
                                                 ...
                                                 [NotNullWhen(false)] out String?  Error)
        {
            ...
            try
            {
                ...
                // section the next start refuses, and an EMSP that does not
        ...
        /// servers in effect, which the section cannot know and this EMSP
        /// does.
        /// </remarks>
                                          ...
                                          [NotNullWhen(false)] out String?  Error)
        {
                ...
                Configuration.Hostname   is null)
            {
                ...
                if (quorum > asked)
                {
                    Error = $"'nts.minServers' is {quorum}, which is more servers than the {asked} this EMSP asks.";
                    return false;
                }
        ...
        private void ApplyNTSConfiguration(NTSConfiguration Configuration)
        {
            ...
            // is this group that decides whether the EMSP may say it has
            // legal time.
                ...
                ntp      != ntsClient.NTP_Port)
            {
                ...
                // about the last exchange belongs to a server this EMSP no
                // longer asks.
                lastTimeSync = null;
            ...
            // The clock is checked on a timer set when the EMSP started, so
