...
namespace cloud.charging.open.EMSP
{
    ...
    /// <summary>
    /// Making this EMSP try something, to find out whether it can:
    ...
    public partial class EMSP
    {
                                                ...
                                                CancellationToken                     CancellationToken   = default)
        {
            ...
            if (!DNSEnabled)
            {
                ...
                return Failed(name, asked, "Name resolution is switched off on this EMSP.");
            }
                                                       ...
                                                       CancellationToken  CancellationToken   = default)
        {
            ...
            // typing mistake, which is why everything else this EMSP prints
            // leaves it out.
            ...
            try
            {
                ...
                Step("notice", offset.HasValue
                                   ...
                                   : $"{name} answered, but said nothing this EMSP could take an offset from.");
        ...
        public async Task<JObject> SyncTimeAsync(CancellationToken CancellationToken = default)
        {
            ...
            if (!NTSEnabled)
            {
                Log.Warning("Time synchronisation was not run: NTS is switched off on this EMSP.", "nts", "test");
