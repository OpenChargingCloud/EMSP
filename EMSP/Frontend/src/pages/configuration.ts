...
/**
 * What this EMSP is made of - read-only: it answers "what am I
...
export const configurationPage: Page = {
    ...
    render({ root }) {
        ...
        const content = shell(root, {
            ...
            title:     'Configuration',
            subtitle:  'What this EMSP is made of.',
            ...
            try
            {
                ...
                render(content, html`
                    ...
                    <div class="cards">
                        ...
                        ${card('EMSP', 'fa-handshake', configuration.EMSP, html`
                            <div class="kv">
...
/**
 * One section: every field the EMSP sent, in the order it sent them,
