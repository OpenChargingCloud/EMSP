 ...
 * inside the EMSP that resolves anything - the name servers included, which
...
export const dnsPage: Page = {
    ...
    render({ root }) {
        ...
        const content = shell(root, {
            ...
            title:     'DNS client',
            subtitle:  'How this EMSP resolves names.',
            ...
            render(content, html`
                ...
                <div class="cards stacked">
                    ...
                    <section class="card">
                        ...
                        <p class="hint">
                            Switched off, this EMSP asks nobody: the name servers are taken away from
                    ...
                    <section class="card">
                        ...
                        <p class="hint">Changing these means making another client, which means restarting the EMSP.</p>
                    </section>
        ...
        async function save(update: DNSUpdate): Promise<void> {
            ...
            try
            {
                ...
                // the page shows what the EMSP took rather than what the
                // form sent.
