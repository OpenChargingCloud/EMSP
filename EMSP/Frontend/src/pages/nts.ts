 ...
 * made for - but that happens inside the EMSP and takes effect at once, so
...
export const ntsPage: Page = {
    ...
    render({ root }) {
            ...
            render(content, html`
                ...
                <div class="cards">
                    ...
                    <section class="card">
                        ...
                        <p class="hint">
                            Switched off, this EMSP asks its time server nothing at all - the
                        ...
                        <p class="hint">
                            ${mayTest
                                  ? html`
                                      ...
                                      this EMSP is not stepped by it - that is a different thing, with meter
         ...
         *
         * Every word of the verdict comes from the EMSP: whether a time
         ...
         * would sooner or later say "legal" where the EMSP says nothing
         * of the kind.
         */
                    ...
                    <p class="hint">
                        ${now.legal
                              ? html`
                                ...
                                `
                              : html`
                                  Unverified: ${why[now.why ?? ''] ?? 'the EMSP did not say why'}. The
                                  time above is still this EMSP's own clock and is still what everything
