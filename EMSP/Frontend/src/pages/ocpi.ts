 ...
 * have sent - read-only, on purpose.
 *
        ...
        function draw(ocpi: OCPIConfiguration): void {
            ...
            render(content, html`
                ...
                <div class="cards">
                    ...
                    <section class="card">
                        <h2><i class="fa-solid fa-id-badge"></i> This EMSP</h2>
                        <div class="kv-list">
                        ...
                        <p class="hint">
                            ...
                            knows this EMSP by these, so they are not changed while it runs.
                        </p>
                    </section>
                    ...
                    <section class="card wide">
                        ...
                        <p class="hint">
                            ...
                            by this EMSP; a partner needs the token it was given to call any of them.
                        </p>
