...
/** What a page says while it is telling the EMSP. */
export const beingSaved = 'Saving ...';

/**
 * Hold a page still while the EMSP is being told, and say so.
 *
...
/**
 * One value of the configuration, as a line of text. Everything the EMSP
...
export function formatValue(value: unknown): string {
    ...
    // A field the EMSP left empty is a field with nothing in it, and an
    ...
    // The EMSP writes its times in ISO 8601, which is the right thing to
...
/** Whether a string is an ISO 8601 moment, as the EMSP writes them. */
...
/**
 * The words that are not words: an acronym the EMSP sends in lower case
