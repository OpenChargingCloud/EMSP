...
namespace cloud.charging.open.EMSP.Logging
{

    /// <summary>
    /// Everything that happens inside this EMSP, in one place: the
    ...
    /// actually has in front of an EMSP is "what happened just now",
    ...
    public sealed class EventLog
    {
        ...
        /// somewhere else than the rest of the EMSP is a log that cannot be
        ...
        /// <summary>Something is not as it should be, but the EMSP carries on.</summary>
