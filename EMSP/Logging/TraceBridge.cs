...
namespace cloud.charging.open.EMSP.Logging
{
    ...
    /// <summary>
    /// Everything the libraries below this EMSP write with Illias' DebugX,
    ...
    /// release build shows on the Logs page is what this EMSP logs itself.
    ///
    ...
    /// away. What an EMSP overhears is mostly OCPI going past it in both
    ...
    public sealed class TraceBridge : TraceListener
    {
        ...
        /// tell what the EMSP said itself from what it overheard.
        /// </summary>
