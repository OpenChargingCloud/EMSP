...
namespace cloud.charging.open.EMSP.Tests
{
    ...
    /// <summary>
    /// What happened inside this EMSP, as a browser reads it: a
    /// snapshot of what led up to now, and then everything from now on over one
    /// Server-Sent Events stream.
    /// </summary>
    public class EventLogTests : AEMSPTests
    {
        ...
        public async Task TheSnapshotCarriesWhatHappened()
        {
            ...
            EMSP.Log.Notice("A line written by a test.", "test");
        ...
        public async Task ATagFiltersTheLog()
        {
            ...
            EMSP.Log.Notice ("The first of two.",  "marked");
            EMSP.Log.Warning("The second of two.", "marked");
            EMSP.Log.Info   ("Not one of them.",   "elsewhere");
            ...
            Assert.Multiple(() => {
                ...
                // something the EMSP writes to its log.
