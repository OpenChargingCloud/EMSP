...
namespace cloud.charging.open.EMSP.Tests
{
    ...
    internal sealed class EventStream : IDisposable
    {
        ...
        #region (static) OpenAndSettle(EMSP, HTTP)
        ...
        /// immediately stopped the EMSP would usually catch the handler
        /// still writing, where a closed socket ends it by itself, and would
        /// therefore pass against an EMSP that cannot shut down at all.
        ///
        ...
        /// </remarks>
        public static async Task<EventStream> OpenAndSettle(EMSP  EMSP,
                                                            HttpClient       HTTP)
        {
