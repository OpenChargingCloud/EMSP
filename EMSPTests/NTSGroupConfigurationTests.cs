...
namespace cloud.charging.open.EMSP.Tests
{
    ...
    public class NTSGroupConfigurationTests
    {
        ...
        /// <summary>
        /// Three servers and a quorum of four is an EMSP that can never have
        ...
        /// decides whether the EMSP may say it has legal time.
        /// </remarks>
        [Test]
        ...
        public void WhatIsWrittenComesBack()
        {
            ...
            Assert.Multiple(() => {
                ...
                // EMSP wrote reads the way somebody would have written it.
